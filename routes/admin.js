...
const onlinePitch_controller = require('../controllers/admin/onlinePitch_controller')
...
// CRUD PITCH ONLINE
router.get('/online-pitch', onlinePitch_controller.viewPitch)
router.put('/online-pitch', onlinePitch_controller.editPitch)
